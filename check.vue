<template>
  <el-word-select @change="handleSelectChange" :static="needStatic">
    <div
      id="subject_summary"
    ...
    <el-form-renderer ref="form" :content="formContent" />
    <el-button>搜索相关</el-button>
  </el-word-select>
</template>
...
const DEFAULT_FORM_CONTENT = [
  {
    ...
    rules: [{required: true, message: 'miss name', trigger: 'blur'}]
  },
  {
    type: 'select',
    id: 'cat',
...
export default {
  ...
  computed: {
    formContent() {
      const [inputContent, selectContent] = DEFAULT_FORM_CONTENT
      const newInputContent = {...inputContent, default: this.selectWorld}
      return [newInputContent, selectContent]
    }
  },
  methods: {
