...
git remote add github https://$GITHUB_TOKEN@github.com/sociosarbis/el-word-select.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/sociosarbis/el-word-select/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "el-word-select更新", "text": "@所有人\n# [el-word-select('$version')]('$html_url')\n'$body'"}}'
